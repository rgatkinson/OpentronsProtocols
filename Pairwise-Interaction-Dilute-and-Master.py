...
p300.transfer(dilution_source, idt_strand_a, diluted_strand_a, trash=trash_control, mix_before=(2, dilution_mix), mix_after=(3, dilution_mix))
p300.transfer(dilution_source, idt_strand_b, diluted_strand_b, trash=trash_control, mix_before=(2, dilution_mix), mix_after=(3, dilution_mix))
