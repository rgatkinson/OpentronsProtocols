...
log('Liquid Names')
note_liquid(location=water, name='Water', min_volume=min_water_volume)
...
def plate_dilution(source, stride, offset):
...
log('Plating')
plate_dilution(dilutions[1], stride=2, offset=0)
plate_dilution(water, stride=2, offset=1)
